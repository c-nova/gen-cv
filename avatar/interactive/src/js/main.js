...
supported_languages = ["ja-JP", "en-US", "de-DE", "zh-CN"] // The language detection engine supports a maximum of 4 languages
...
window.startRecording = () => {
  const speechConfig = SpeechSDK.SpeechConfig.fromAuthorizationToken(token, 'japaneast');
